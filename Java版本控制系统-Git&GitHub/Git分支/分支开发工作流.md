...
img: assets/分支开发工作流/git-workflow-release-cycle-3release.png
categories: 编程知识
---
...
![集中式工作流](assets/分支开发工作流/git-workflow-svn.png)
...
![功能分支工作流](assets/分支开发工作流/git-workflow-feature_branch.png)
...
![GitFlow工作流](assets/分支开发工作流/git-workflows-gitflow.png)
...
![](assets/分支开发工作流/git-workflow-forking.png)

## Pull Requests

Pull requests 让开发者更方便地进行协作的功能，提供了友好的 Web 界面可以在提议的修改合并到正式项目之前对修改进行讨论。

![img](assets/分支开发工作流/pull-request.png)
...
![集中工作流](assets/分支开发工作流/git-workflow-svn-1590579899618.png)
...
![Git push](assets/分支开发工作流/git-workflow-svn-push-local.png)
...
![push冲突](assets/分支开发工作流/git-workflow-svn-managingconflicts.png)
...
![初始化中央仓库](assets/分支开发工作流/git-workflow-svn-initialize.png)
...
![所有人克隆中央仓库](assets/分支开发工作流/git-workflow-svn-clone.png)
...
![小明本地开发功能](assets/分支开发工作流/git-workflow-svn-1.png)
...
![小红本地开发功能](assets/分支开发工作流/git-workflow-svn-2.png)
...
![小明发布功能](assets/分支开发工作流/git-workflow-svn-3.png)
...
![小红尝试发布功能](assets/分支开发工作流/git-workflow-svn-4.png)
...
![小红rebase](assets/分支开发工作流/git-workflow-svn-5.png)
...
![rebase](assets/分支开发工作流/git-workflow-svn-6.png)
...
![小红解决冲突](assets/分支开发工作流/git-workflow-svn-7.png)
...
![合并冲突](assets/分支开发工作流/git-workflow-svn-8.png)
...
![小红发布成功](assets/分支开发工作流/git-workflow-svn-9.png)
...
![功能分支工作流](assets/分支开发工作流/git-workflow-feature-branch-1.png)
...
![小红开发新功能](assets/分支开发工作流/git-workflow-feature-branch-2.png)
...
![小红push备份](assets/分支开发工作流/git-workflow-feature-branch-3.png)
...
![小红发起PullRequest](assets/分支开发工作流/git-workflow-feature-branch-4.png)
...
![小黑收到PullRequest](assets/分支开发工作流/git-workflow-feature-branch-5.png)

小黑收到了 Pull Request 后会查看 marys-feature 的修改。决定在合并到正式项目前是否要做些修改，且通过 Pull Request 和小红来回地讨论。

### 小红再做修改

![小红继续修改](assets/分支开发工作流/git-workflow-feature-branch-6.png)
...
![小红发布](assets/分支开发工作流/git-workflow-feature-branch-7.png)
...
![GitFlow工作流](assets/分支开发工作流/git-workflows-gitflow-1590584010793.png)
...
![历史分支](assets/分支开发工作流/git-workflow-release-cycle-1historical.png)
...
![功能分支](assets/分支开发工作流/git-workflow-release-cycle-2feature.png)
...
![发布分支](assets/分支开发工作流/git-workflow-release-cycle-3release.png)
...
![维护分支](assets/分支开发工作流/git-workflow-release-cycle-4maintenance.png)
...
![创建开发分支](assets/分支开发工作流/git-workflow-release-cycle-5createdev.png)
...
![小红小明单独开发功能](assets/分支开发工作流/git-workflow-release-cycle-6maryjohnbeginnew.png)
...
![小红完成](assets/分支开发工作流/git-workflow-release-cycle-7maryfinishes.png)
...
![img](assets/分支开发工作流/git-workflow-release-cycle-8maryprepsrelease.png)
...
![Bug修复](assets/分支开发工作流/git-workflow-gitflow-enduserbug.png)
...
![Forking工作流](assets/分支开发工作流/git-workflows-forking.png)
...
![初始化正式仓库](assets/分支开发工作流/git-workflows-forking-1.png)
...
![fork正式仓库](assets/分支开发工作流/git-workflows-forking-2.png)
...
![克隆fork仓库到本地](assets/分支开发工作流/git-workflows-forking-3.png)
...
![各自开发功能](assets/分支开发工作流/git-workflows-forking-4.png)
...
![发布自己的功能到fork仓库](assets/分支开发工作流/git-workflows-forking-5.png)
...
![所有开发者同步正式仓库](assets/分支开发工作流/git-workflows-forking-7.png)
...
![Pull Request](assets/分支开发工作流/pull-request-bitbucket.png)
...
![讨论提交修改](assets/分支开发工作流/pull-request-overview.png)
...
![PullRequest四信息](assets/分支开发工作流/pull-request-anatomy.png)
...
![功能分支中使用PullRequest](assets/分支开发工作流/pull-request-feature-branch.png)
...
![GitFlow工作流使用PullRequest](assets/分支开发工作流/gitflow-workflow-pull-request.png)
...
![向正式仓库PullRequest](assets/分支开发工作流/pull-request-forking-workflow-1.png)
...
![向其他开发者仓库PullRequest](assets/分支开发工作流/pull-request-forking-workflow-2.png)
...
![小红fork小明](assets/分支开发工作流/pull-request-1.png)

小红先要 fork 小明的 Bitbucket 仓库，开始项目的开发。她登陆 Bitbucket，浏览到小明的仓库页面，点 Fork 按钮。

![Fork](assets/分支开发工作流/pull-request-2.png)
...
![小红克隆她的 Bitbucket 仓库](assets/分支开发工作流/pull-request-3.png)
...
![小红push到自己的Bitbucket仓库](assets/分支开发工作流/pull-request-5.png)
...
![发起 Pull Request](assets/分支开发工作流/example-6.png)
...
![Pull Request信息](assets/分支开发工作流/pull-request-7.png)
...
![小明收到小红的Pull Request](assets/分支开发工作流/pull-request-8.png)
...
![讨论Bug](assets/分支开发工作流/pull-request-9.png)
